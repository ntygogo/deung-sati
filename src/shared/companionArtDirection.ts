...
export const COMPANION_COLLECTIONS = {
  ...
  earth: { name:'สวนโอปอล', subtitle:'ธาตุดิน · ผลึกมนและวงแหวนแร่', palette:'soft_sakura', pattern:'starlight_speckles', motion:'serene_swaying', lampShape:'pearl', body:'#DEA58D',face:'#EDB89C',belly:'#FFE0AE',fin:'#538F83',finTip:'#A0DCBD',marking:'#8C5969',cheek:'#DF7F83',lamp:'#FFE1A0' },
  water: { name:'บัวแก้ว', subtitle:'ธาตุน้ำ · หยดแก้วและฟองมุก', palette:'jade_mint', pattern:'water_ripples', motion:'serene_swaying',lampShape:'drop',body:'#72C7C8',face:'#94D8D2',belly:'#FFE0BD',fin:'#428BBA',finTip:'#B7ADF0',marking:'#346F91',cheek:'#F1A391',lamp:'#A2F6E5' },
  wind: { name:'เมฆอรุณ',subtitle:'ธาตุลม · ปุยเมฆและริ้วลม',palette:'powder_blue',pattern:'water_ripples',motion:'dreamy_drift',lampShape:'pearl',body:'#B49AD9',face:'#C5ACE7',belly:'#FFE3BB',fin:'#6879B9',finTip:'#F3BCBA',marking:'#755195',cheek:'#E894AE',lamp:'#FFE4A3' },
  fire: { name:'เปลวพีช',subtitle:'ธาตุไฟ · เปลวอุ่นและกลีบเพลิง',palette:'soft_sakura',pattern:'petal_marks',motion:'curious_peek',lampShape:'drop',body:'#F2A08A',face:'#F6B39A',belly:'#FFDBA1',fin:'#BC527F',finTip:'#F9BE67',marking:'#AD4770',cheek:'#E77679',lamp:'#FFC465' },
  leaf: { name:'ภูตพิสตาชิโอ',subtitle:'ใบไม้ · ยอดอ่อนและใบหยก',palette:'jade_mint',pattern:'water_ripples',motion:'serene_swaying',lampShape:'bud',body:'#B4CF87',face:'#CBDB9A',belly:'#FFE4B7',fin:'#4C9A80',finTip:'#E9A3B8',marking:'#528B68',cheek:'#E9A090',lamp:'#F9D988' },
  flower: { name:'พีโอนีบลูม',subtitle:'ดอกไม้ · ดอกบานและกลีบซ้อน',palette:'soft_sakura',pattern:'petal_marks',motion:'dreamy_drift',lampShape:'bud',body:'#E89ABA',face:'#F0ACC7',belly:'#FFDCBD',fin:'#925FAD',finTip:'#F4B5D1',marking:'#9B457F',cheek:'#E579A0',lamp:'#FFDA84' },
} as const;
