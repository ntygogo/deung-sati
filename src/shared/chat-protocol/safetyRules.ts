...
const CRISIS_KEYWORDS_REGEX =
  /(อยากตาย|ไม่อยากอยู่|ทำร้ายตัวเอง|กรีดแขน|กินยาตาย|ฆ่าตัวตาย|กินยาหมดแผง|กินยาให้ตาย|กินยาเกินขนาด|จะกระโดด|ลาโลก|ผูกคอ|แทงตัวเอง|จบชีวิต|ไม่อยากมีชีวิต|ไม่อยากตื่น|อยากหลับไปตลอด|อยากหายไปตลอดกาล|อยากฆ่าตัวตาย|ไม่อยากอยู่บนโลก|ทรมานจนไม่อยาก|เหนื่อยจนไม่อยากอยู่)/i;
