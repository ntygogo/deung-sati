...
export const GUIDED_EXERCISE_CATALOG: Record<string, GuidedExerciseDefinition> = {
  ...
  before_speak: {
    id: 'before_speak',
    title: 'กรองคำก่อนพูด',
    subtitle: 'พิมพ์อย่างที่อยู่ในหัว แล้วช่วยจัดระเบียบให้สื่อสารได้จริง',
    icon: '✉️',
    estimatedDuration: '1 นาที',
    steps: [
      {
        stepIndex: 1,
        totalSteps: 1,
        title: 'พิมพ์สิ่งที่อยากพูดออกมาได้เลย',
        instruction: 'ไม่ต้องสุภาพ ไม่ต้องกรองคำ เขียนอย่างที่มันอยู่ในหัวตอนนี้ได้เลย',
        hint: 'เช่น "ทำไมอ่านแล้วไม่ตอบ กูโคตรไม่โอเคเลย"',
        inputType: 'text',
        inputPlaceholder: 'ทำไมอ่านแล้วไม่ตอบ กูโคตรไม่โอเคเลย',
        actionLabel: 'ช่วยกรองให้หน่อย',
      },
    ],
  },
